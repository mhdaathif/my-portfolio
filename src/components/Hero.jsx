            ...
            <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
                ...
                <div className='md:w-1/2 mb-10 md:mb-0'>
                    <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                        Hi, I'm <span className='text-purple'>Mohamed Aathif</span>
                    </h1>
                    <h2 className='text-2xl md:text-4xl font-semibold mb-6 typewroter'>Full Stack Developer</h2>
                    ...
                    <div className='flex space-x-4'>
                        <a href="#projects" className='px-6 py-3 bg-purple rounded-lg font-medium hover:bg-purple-700 duration-300'>View Work</a>
