                    ...
                    <div className='space-y-12'>
                        {
                            workData.map((data, index)=> (
                                <div 
                                key={index}
                                className="timeline-item relative pl-12 before:content-[''] before:absolute before:left-0 before:top-0 before:w-[2px] 
                                before:h-full before:bg-purple cursor-pointer hover:translate-y-2 transition-all duration-300"
                                >
                                    {/* Time Line */}
                                    ...
                                    <div className='bg-dark-300 rounded-2xl p-6'>
                                        ...
                                        <p className='text-gray-400 mb-2'>{data.duration}</p>
